...
const token = 'NjUyODg5MDU5Mzk1NTAyMTEx.XevAUQ.nvUwF3nj6fiC85gFvPFcuAvACxw'; //Dette er discord bottens token som den skal bruge til at logge ind med
...
function activity(){ // laver funktionen activity
    setTimeout(() => { // laver et loop
        fivereborn.query("193.70.81.148","30120", (err, data) => { // starter fivereborn event, IP:PORT
